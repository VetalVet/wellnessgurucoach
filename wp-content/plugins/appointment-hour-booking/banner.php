				...
				<div id="codepeople-review-banner">
					...
					<div class="codepeople-review-banner-content">
						<div class="codepeople-review-banner-text">
							<p>Hey, I noticed you are using the "<?php print esc_html($plugin_data[ 'plugin_name' ]); ?>" plugin – <strong>that’s awesome!</strong> Could you please do me a <strong>BIG</strong> favor and <a href="https://wordpress.org/support/plugin/appointment-hour-booking/reviews/#new-post" style="color:#1582AB;font-weight:bold;text-decoration: underline;">give it a 5-star rating on WordPress</a>? Just to help us spread the word and boost our motivation. <strong>Thank you!</strong></p>
						</div>
						<div class="codepeople-review-banner-buttons">
                            ...
                            <br />
                            <p>Need help using the plugin? Feel free to <a href="https://wordpress.org/support/plugin/appointment-hour-booking">open a support ticket</a> and I will be happy to help you!</p>
						</div>
